...
## 9) Cách dùng trên Google Chat

1. Vào **Google Chat**.
2. Chọn **New Chat**.
3. Tìm và chọn **Information Chatbot**.
4. Bắt đầu chat với bot.

---

## 10) Cách reindex không cần vào Google Chat

Dùng **Google Cloud Shell**:

```bash
curl -s -X POST "https://chatbot-xxxxxxxxxx.asia-northeast1.run.app/" \
...
## 13) Định hướng cải thiện trong tương lai
...
## 14) Đánh giá hiện trạng demo

### 14.1 Phần đã hoàn thiện
...
https://github.com/user-attachments/assets/24682cd9-a397-41b4-8b58-9260e633ca59
